...
class ODataClient implements IODataClient
{
	 ...
	 * @return IODataRequest
	 */
	public function post($requestUri, $postData, ?Closure $alterRequest = null)
	{
		return $this->request(HttpMethod::POST, $requestUri, $postData, $alterRequest);
	}
	 ...
	 * @throws ODataException
	 */
	public function request($method, $requestUri, $body = NULL, ?Closure $alterResult = null)
	{
		...
		return $request->execute($alterResult);
	}
